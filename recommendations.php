	...
	<main>
		<section class="recommendations-header full-view-width-height has-background">
			<div class="recommendations-header-wrapper pa-5">
				...
				<br>
				<p>
					During out tours, we make refferences to many other Nordic Noir films, TV-series and sometimes novels. If they take place in Copenhagen, we show the locations.
				</p>
				<br>
				<p>
					If you can't get your appetite for Nordic Noir genre satisfied, here are some suggestions (after of course you have see Wallander 2013-2015, SWE and stieg Larsson's Millenniu 2010. SWE)
				</p>
				<br>
				<p>
					Please take a look at our very subjective list below.	
				</p>
			</div>
		</section>
		<section class="recommendations-list">
			<div class="recommendations-list-wrapper">
				...
				<div class="recommendation pb-5">
					...
					<br>
					<p>The guardian: It's as claustrophobic as Homeland and as tightly wound as the Wire - But in today's climate, with the refugee crisis and the rise in nationalism</p>
					<br>
				...
				<div class="recommendation pb-5">
					...
					<br>
					<p>Takes place on the beautiful islands of Aland (between Sweeden and Finland)</p>
				</div>
			</div>
		</section>
	</main>
